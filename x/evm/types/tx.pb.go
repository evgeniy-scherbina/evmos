...
func (m *MsgEthereumTx) GetData() *types.Any {
	if m != nil {
		return m.Data
	}
	return nil
...
func (m *MsgEthereumTx) GetSize_() float64 {
	if m != nil {
		return m.Size_
	}
	return 0
...
func (m *MsgEthereumTx) GetFrom() string {
	if m != nil {
		return m.From
	}
	return ""
...
var fileDescriptor_964254b923cd5aaa = []byte{
	...
	,
}
